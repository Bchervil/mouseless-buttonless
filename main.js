					...
					if (this.x > 1600) {
						...
						if (this.x > 1800) {
							...
							if (this.x > 2200) {
								...
								if (this.x > 3000) {
									  this.x = 2600;
									  window.location.href = "https://bchervil.github.io/Portfolio/"
								}
							}
						}
					}
